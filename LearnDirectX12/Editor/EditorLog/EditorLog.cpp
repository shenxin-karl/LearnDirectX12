...
std::shared_ptr<EditorLog> EditorLog::instance() {
    static std::shared_ptr<EditorLog> pEditorLog = std::make_shared<EditorLog>();
    return pEditorLog;
}
...
bool *EditorLog::getOpenFlagPtr() {
    return &_showLogWindow;
}
...
void EditorLog::setShadowWindow(bool bShow) {
