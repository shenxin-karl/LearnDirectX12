...
std::shared_ptr<dx12lib::Texture> TextureManager::get(const std::string &fileName) const {
...
void TextureManager::set(const std::string &fileName, std::shared_ptr<dx12lib::Texture> pShaderResource) {
