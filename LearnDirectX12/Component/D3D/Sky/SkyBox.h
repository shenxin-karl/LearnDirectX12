...
struct SkyBoxDesc {
	...
	std::shared_ptr<dx12lib::Texture> pCubeMap;
...
public:
	...
	std::shared_ptr<dx12lib::Texture> getEnvironmentMap() const;
	void setEnvironmentMap(std::shared_ptr<dx12lib::Texture> pCubeMap);
...
private:
	...
	std::shared_ptr<dx12lib::Texture> _pCubeMap;
};
