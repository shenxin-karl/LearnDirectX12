...
private:
	...
	static void readSubsetTable(std::ifstream &fin, size_t numSubsets, std::vector<d3d::SubMesh> &subsets);
	...
	static void readBoneKeyframes(std::ifstream &fin, size_t numBones, BoneAnimation &boneAnimation);
};
