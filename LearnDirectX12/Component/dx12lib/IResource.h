...
interface IShaderResource : virtual IResource {
	...
	virtual ShaderResourceView getShaderResourceView(size_t mipSlice = 0) const = 0;
...
/////////////////////////////////////////////ShaderResource/////////////////////////////////////////////
interface IShaderResource2D : virtual IShaderResource {
	ShaderResourceDimension getDimension() const override;
};

interface IShaderResource2DArray : virtual IShaderResource {
	ShaderResourceDimension getDimension() const override;
	virtual ShaderResourceView getShaderResourceView(size_t planeSlice, size_t mipSlice = 0) const = 0;
	virtual size_t getPlaneSlice() const = 0;
};

interface IShaderResourceCube : virtual IShaderResource {
	ShaderResourceDimension getDimension() const override;
	virtual ShaderResourceView getShaderResourceView(CubeFace face, size_t mipSlice = 0) const = 0;
};
/////////////////////////////////////////////RenderTarget/////////////////////////////////////////////
interface IRenderTarget2D : virtual IShaderResource {
	virtual RenderTargetView getRenderTargetView(size_t mipSlice = 0) const = 0;
};

interface IRenderTarget2DArray : virtual IShaderResource {
	virtual RenderTargetView getRenderTargetView(size_t planeSlice, size_t mipSlice = 0) const = 0;
};

interface IRenderTargetCube : virtual IShaderResource {
	virtual RenderTargetView getRenderTargetView(CubeFace face, size_t mipSlice = 0) const = 0;
};
/////////////////////////////////////////////UnorderedAccess/////////////////////////////////////////////
interface IUnorderedAccess2D : virtual IShaderResource {
	virtual UnorderedAccessView getUnorderedAccessView(size_t mipSlice = 0) const = 0;
};

interface IUnorderedAccess2DArray : virtual IShaderResource {
	virtual UnorderedAccessView getUnorderedAccessView(size_t planeSlice, size_t mipSlice = 0) const = 0;
};

interface IUnorderedAccessCube : virtual IShaderResource {
	virtual UnorderedAccessView getUnorderedAccessView(CubeFace face, size_t mipSlice = 0) const = 0;
};
